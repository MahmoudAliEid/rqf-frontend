...
const resources = {
  en: {
    translation: {
      ...
      slide2:
        "Enjoy the taste of healthy, nutritious nuts rich in energy and natural benefits",
      slide22: "Fresh, delicious, and perfect for every moment",
      slide3: "Togetherness means Barham Rice",
      slide33:
        "Prepare the most delicious, fresh, healthy, and nutritious meals with Barham Rice",
      slide4: "Delicious dried fruits",
      slide44:
        "Rich in flavor and amazing benefits, perfect for every moment. Discover their benefits!",
      slide5: "Premium spices",
      slide55:
        "Rich flavor and unmatched quality to give you the best cooking experience – fresh, healthy, and perfect for every meal!",
      slide6: "Coffee is not just a drink",
      slide66:
        "It’s a rich experience that combines health benefits and unique flavor for a perfect start to your day",
      slide666:
        "Rich flavor and unmatched quality to give you the best cooking experience – fresh, healthy, and perfect for every meal!",

      footer: {
        about:
          "RQF Consulting Company is one of the leading companies in the field of high-level management consulting. Founded with over 15 years of experience, we pride ourselves on offering the highest standards of quality and professionalism in business consulting, with a special focus on strategic management and organizational development.",
        fastlink: {
          title: "Quick Links",
          home: "Home",
          about: "About Us",
        ...
        services: {
          ...
          medical_licensing: "Medical Device Licensing",
      ...
      aboutpage: {
        section1: {
          ...
          description:
            "Marina Group for Import and Export was established in 2000 in Hebron – Palestine. The company specializes in importing and distributing food products, with a particular focus on tuna and other high-quality food items.",
      ...
      commitment1: {
        quality:
          "We conduct more than 150 quality tests daily to ensure we provide the best types of nuts and 100% fresh and natural food products worthy of your trust.",
        import:
          "We import the finest types of nuts and food products from more than 12 countries around the world, including Turkey, Egypt, the United States, India, China, the UAE, Saudi Arabia, Afghanistan, and many more.",
        points:
          "We supply our products to more than 800 wholesale points of sale throughout Jordan, with plans to expand in the region.",
      },
      ...
      hero: {
        ...
        description:
          "Your partners in success, helping you realize your vision through top-tier consulting services and innovative solutions.",
        team_commitment:
          "Our team of experts is committed to delivering tailored solutions to boost your organizational capabilities.",
      ...
      ProductCarousel: {
        ...
        qoute:
          "We are proud to offer a wide range of high-quality products to our customers.",
      ...
      create_consultant: {
        ...
        ar_education_placeholder:
          "e.g., ماجستير إدارة الأعمال، دكتوراه في الإدارة",
      },
      edit_consultant: {
      ...
      about_us: {
        ...
        mission: {
          title: "Our Mission",
          description:
            "To provide exceptional consulting services that empower organizations to achieve their strategic goals through innovative solutions and expert guidance.",
        },
        vision: {
          title: "Our Vision",
          description:
            "To be the leading consulting firm in the Middle East, recognized for our commitment to excellence, integrity, and transformative impact on our clients' success.",
        },
        values: {
          title: "Our Values",
          excellence: {
          ...
          integrity: {
            title: "Integrity",
            description:
              "We conduct business with honesty, transparency, and ethical principles at the core of our operations.",
          },
          innovation: {
            title: "Innovation",
            description:
              "We embrace creative thinking and innovative approaches to solve complex business challenges.",
          },
          partnership: {
            title: "Partnership",
            description:
              "We build lasting relationships with our clients, working together as trusted partners in their success journey.",
          },
        },
        statistics: {
      ...
      our_services: {
        ...
        description:
          "We offer a full range of consulting services designed to help your organization achieve its strategic objectives and drive sustainable growth.",
      ...
      our_team: {
        ...
        description:
          "Our team consists of highly qualified consultants with extensive experience across various industries and specializations.",
      ...
      contact_us: {
        ...
        contact_description:
          "Contact us through any of the following channels, and we will respond as soon as possible.",
        form: {
          name: "Full Name",
        ...
        info: {
          ...
          phone: "+966 55 995 5773",
          address: "Riyadh, Floor 4, Unit 402 - Saudi Arabia",
          working_hours: "Sunday to Thursday: 10:00 AM - 6:00 PM",
        },
      },
      ...
      medical_licensing: {
        ...
        description:
          "We are licensed by SFDA for licensing systems, supporting foreign companies in obtaining licenses for their medical devices within Saudi Arabia efficiently.",
        form: {
          ...
          device_type_placeholder:
            "Describe the medical devices to be licensed",
      ...
      consultation_booking: {
        ...
        form: {
          ...
          booking: "Booking...",
          success:
            "Consultation booked successfully! You will receive confirmation details via email.",
  ...
  ar: {
    translation: {
      ...
      hero: {
        ...
        description:
          "نحن شركاؤكم في النجاح، نساعدكم على تحقيق رؤيتكم من خلال خدمات استشارية عالية الجودة وتقنيات مبتكرة.",
        team_commitment:
          "فريقنا من الخبراء ملتزم بتقديم حلول مخصصة لتعزيز قدرات مؤسستكم.",
      ...
      slide2:
        "   استمتع بمذاق المكسرات الصحية والمغذية الغنية بالطاقة والفوائد الطبيعية",
      ...
      slide5: "   بهارات فاخرة ",
      slide55:
        "   نكهة غنية وجودة لا تضاهى ، لتمنحك أفضل تجربة طهي طازجة، صحية ومثالية لكل وجبة ! ",
      slide6: "   القهوة ليست مجرد مشروب ",
      slide66:
        " بل هي تجربة غنية تجمع بين الفوائد الصحية والنكهة الفريدة التي تمنحك بداية مثالية ليومك ",
      slide666:
        "   نكهة غنية وجودة لا تضاهى ، لتمنحك أفضل تجربة طهي طازجة، صحية ومثالية لكل وجبة !   ",

      footer: {
        about:
          "شركة رقف للاستشارات الإدارية هي إحدى الشركات الرائدة في مجال الاستشارات الإدارية عالية المستوى، تأسست بخبرة تزيد عن 15 عامًا، نتميز بتقديم أعلى معايير الجودة والاحترافية في الاستشارات التجارية، مع تركيز خاص على الإدارة الاستراتيجية والتطوير التنظيمي.",
        fastlink: {
          title: "روابط سريعة",
          home: "الرئيسية",
          about: "من نحن",
      ...
      aboutpage: {
        section1: {
          ...
          description:
            "تأسست شركة مارينا جروب للاستيراد والتصدير عام 2000 في مدينة الخليل – فلسطين، وهي شركة متخصصة في استيراد وتوزيع المواد الغذائية، مع التركيز بشكل خاص على منتجات التونا والمواد الغذائية عالية الجودة الأخرى",
        ...
        section4: {
          features: [
            ...
            },
            {
              title: "رسالتنا",
              data: [
                "توفير منتجات غذائية آمنة وصحية للمستهلك الفلسطيني.",
                "بناء شراكات طويلة الأمد مع موردينا العالميين.",
                "تقديم خدمة عملاء متميزة وسريعة.",
                "المساهمة في دعم الاقتصاد الوطني من خلال توفير فرص عمل وتوسيع نطاق الاستيراد.",
              ],
            },
          ],
        },
      ...
      create_consultant: {
        ...
        specialization_placeholder:
          "مثل: التخطيط الاستراتيجي، إدارة الموارد البشرية",
      ...
      about_us: {
        ...
        mission: {
          title: "رسالتنا",
          description:
            "تقديم خدمات استشارية استثنائية تمكن المنظمات من تحقيق أهدافها الاستراتيجية من خلال حلول مبتكرة وإرشادات خبيرة.",
        },
        vision: {
          title: "رؤيتنا",
          description:
            "أن نكون الشركة الاستشارية الرائدة في الشرق الأوسط، معترف بها لالتزامنا بالتميز والنزاهة والأثر التحويلي على نجاح عملائنا.",
        },
        values: {
          title: "قيمنا",
          excellence: {
            title: "التميز",
            description:
              "نسعى لأعلى المعايير في كل ما نقوم به، ونقدم نتائج استثنائية تتجاوز التوقعات.",
          },
          integrity: {
            title: "النزاهة",
            description:
              "نمارس الأعمال بصدق وشفافية ومبادئ أخلاقية في صميم عملياتنا.",
          },
          innovation: {
            title: "الابتكار",
            description:
              "نتبنى التفكير الإبداعي والأساليب المبتكرة لحل التحديات التجارية المعقدة.",
          },
          partnership: {
            title: "الشراكة",
            description:
              "نبني علاقات دائمة مع عملائنا، نعمل معًا كشركاء موثوقين في رحلة نجاحهم.",
          },
        },
        statistics: {
      ...
      our_services: {
        ...
        description:
          "نقدم مجموعة كاملة من الخدمات الاستشارية المصممة لمساعدة مؤسستك على تحقيق أهدافها الاستراتيجية ودفع النمو المستدام.",
      ...
      our_team: {
        ...
        description:
          "يتكون فريقنا من مستشارين مؤهلين تأهيلاً عالياً مع خبرة واسعة عبر مختلف الصناعات والتخصصات.",
      ...
      contact_us: {
        ...
        contact_description:
          "تواصل معنا من خلال أي من القنوات التالية، وسنرد عليك في أقرب وقت ممكن.",
        form: {
          name: "الاسم الكامل",
      ...
      medical_licensing: {
        ...
        description:
          "نحن مرخصون لدى هيئة الغذاء والدواء لأنظمة التراخيص، ونقدم الدعم للشركات الأجنبية للحصول على تراخيص لأجهزتها الطبية داخل المملكة العربية السعودية بكفاءة.",
        form: {
      ...
      consultation_booking: {
        ...
        form: {
          ...
          booking: "جارٍ الحجز...",
          success:
            "تم حجز الاستشارة بنجاح! ستصلك تفاصيل التأكيد عبر البريد الإلكتروني.",
